# Contributing to ThinkboxCMLibrary

Thanks for your interest in contributing to ThinkboxCMLibrary! ❤️
...
From the project root directory run the following commands to install the dependencies and build ThinkboxCMLibrary:
...
If you need to publish build artifacts to your local Conan cache manually, after completing the [building](#building) steps, you can run the following commands to package ThinkboxCMLibrary and publish it to your local Conan cache:
